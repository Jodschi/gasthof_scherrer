...
<body>
    ...
    <form action="reservierung.php" method="post">
        ...
        <input type="date" id="date" name="date" required placeholder = "01.01.2020">
        
        <label for="time">Uhrzeit:</label>
        <input type="time" id="time" name="time" required placeholder = "00:00">
        
        <label for="party-size">Größe der Gruppe:</label>
        <input type="number" id="party-size" name="party-size" min="1" required placeholder = "0">
